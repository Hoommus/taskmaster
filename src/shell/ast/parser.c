...
t_token							*offset_list(t_token *list, register int offset)
{
	register int	i;
...
static inline struct s_result	*handle_terminal(struct s_result *result,
	const t_state *state)
{
...
static inline bool				check_rule(struct s_result *result,
